...
private val LightColorScheme = lightColorScheme(
    ...
    surfaceBright = MdThemeLightSurfaceVariant,
    surfaceContainer = MdThemeLightSurfaceVariant,
    surfaceContainerHigh = MdThemeLightPrimaryContainer.copy(alpha = 0.35f),
...
private val DarkColorScheme = darkColorScheme(
    ...
    surfaceBright = MdThemeDarkSurfaceVariant,
    surfaceContainer = MdThemeDarkSurfaceVariant,
    surfaceContainerHigh = MdThemeDarkPrimaryContainer.copy(alpha = 0.45f),
